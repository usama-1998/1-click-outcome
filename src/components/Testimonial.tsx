...
const testimonials: TestimonialData[] = [
  {
    ...
    name: "Mark R.",
    role: "Agency Owner",
    quote: "Before 1 Click Outcome, we were missing calls and letting old leads slip through the cracks. Once they deployed the call intercept and reactivation campaigns, we saw an immediate spike in appointments. Our revenue increased by 40% in just two months without hiring anyone new.",
    seed: "Mark",
    stat1Value: "+112 Appointments",
    stat1Label: "Booked via Reactivation",
  ...
  },
  {
    ...
    quote: "Getting reviews on autopilot is insane. I used to hate begging clients for reviews. Now, the system just asks them automatically after a win. My Google Business Profile went from 12 reviews to 85 in less than four months.",
    seed: "Jason",
  ...
  },
  {
    ...
    quote: "We were skeptical about AI handling our clients, but the natural language processing is incredible. The system qualifies our legal leads perfectly and routes them to the right attorney's calendar without a hitch.",
    seed: "David",
