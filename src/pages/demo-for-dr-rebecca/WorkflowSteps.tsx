      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="text-center max-w-2xl mx-auto mb-20">
          ...
          <p className="text-lg text-white/70">
            Whether it's deploying Grace for telehealth triage, qualifying menopause patients, or syncing with your medical CRM, the workflow is always straightforward. Audit, Build, Scale.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-12 relative">
          ...
          <div className="flex flex-col md:flex-row-reverse items-center gap-12 lg:gap-24 relative z-10">
            ...
            <div className="flex-1 text-left">
              ...
              <p className="text-[17px] text-white/70 leading-relaxed md:ml-14">
                We deploy Grace seamlessly into your clinic's ecosystem. She integrates with your CRM to access telehealth eligibility and books patients directly onto Dr. Rebecca's calendar.
              </p>
            </div>
            {/* Visual Side */}
          ...
          <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-24 relative z-10">
            ...
            <div className="flex-1 text-left">
              ...
              <p className="text-[17px] text-white/70 leading-relaxed md:ml-14">
                Watch your calendar fill up with qualified telehealth appointments. Your team focuses on patient care, while we handle follow-ups, initial triage, and scheduling.
              </p>
            </div>
            {/* Visual Side */}
