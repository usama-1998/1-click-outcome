...
const testimonials: TestimonialData[] = [
  {
    id: 0,
    name: "Dr. Emily Chen",
    role: "Founder, Modern Menopause Care",
    quote: "Before implementing this system, we had hundreds of leads from our Menopause Quiz sitting dormant. Once we deployed Grace, we saw an immediate spike in telehealth consultations. Our clinic's bookings increased by 40% in just two months.",
    seed: "Emily",
    stat1Value: "+112 Appointments",
    stat1Label: "Booked via Grace (SMS)",
  ...
  },
  {
    ...
    role: "Founder, Bennett Women's Health",
    quote: "We were skeptical about AI handling our midlife patients, but the conversational flow is incredible. Grace qualifies our wellness leads perfectly and routes them to my calendar without a hitch.",
    seed: "SarahB",
    stat1Value: "98% Accuracy",
    stat1Label: "In lead qualification routing",
    stat1Icon: "lucide:check-circle",
  ...
  },
  {
    ...
    quote: "We were skeptical about AI handling our patients, but the conversational flow is incredible. Grace qualifies our wellness leads perfectly and routes them to the right practitioner's calendar without a hitch.",
    seed: "SarahB",
